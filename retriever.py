...
if __name__ == "__main__":
    ...
    test_query = ("Был на медосмотре, врач измерил давление и сказал, что у меня 125 на 80, всё идеально. Но дома у "
                  "меня часто болит голова, я купил тонометр, и по вечерам он стабильно показывает 145 на 95. Как "
                  "такое может быть?")
